# Consuming Kinotchi Design System in Expo apps

Read `artifacts/kinotchi-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/kinotchi-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/kinotchi-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/kinotchi-design-system/lib/native-theme";
import { useColors } from "@workspace/kinotchi-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/kinotchi-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/kinotchi-design-system/components/native/badge";
import { Button } from "@workspace/kinotchi-design-system/components/native/button";
import { Card } from "@workspace/kinotchi-design-system/components/native/card";
```
...
Import and render
`@workspace/kinotchi-design-system/components/native/button`, then run Expo
