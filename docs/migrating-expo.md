# Migrating Expo UI to Kinotchi Design System

Read `artifacts/kinotchi-design-system/docs/AGENTS.md` and
`artifacts/kinotchi-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/kinotchi-design-system/lib/native-theme` and
  `@workspace/kinotchi-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/kinotchi-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/kinotchi-design-system` and retains only
