# Migrating web UI to Kinotchi Design System

Read `artifacts/kinotchi-design-system/docs/AGENTS.md` and
`artifacts/kinotchi-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/kinotchi-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/kinotchi-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/kinotchi-design-system/hooks/use-toast`
