...
import {
  ...
  EvolutionPage,
  HabitatsPage,
  KinotchiOverviewPage,
  MotionPage,
  PetsPage,
} from './kinotchi';

const PetStateGalleryDemo = lazyPage(() =>
  import('./demos/pet-state-gallery').then(({ PetStateGalleryPage }) => PetStateGalleryPage),
);
...
export const DESIGN_SYSTEM = {
  title: 'Kinotchi Design System',
  description:
    'A colorful visual language for a desktop digital-pet widget: egg enclosure, square viewport, habitats, pet families, and care rituals.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and product language that shape Kinotchi.',
  Page: KinotchiOverviewPage,
};
    ...
    entries: [
      {
        id: 'brand-enclosure',
        name: 'Egg enclosure',
        description: 'The colorful shell, square digital viewport, and three-button control grammar.',
        Page: KinotchiOverviewPage,
      },
    ],
  },
    ...
    entries: [
      {
        id: 'content-habitats',
        name: 'Habitats',
        description: 'Universal environments open to every pet — ten distinct scenes with one memorable landmark each.',
        Page: HabitatsPage,
      },
      {
        id: 'content-pets',
        name: 'Pet families',
        description: 'Rounded creature silhouettes and their readable signature features.',
        Page: PetsPage,
      },
      {
        id: 'content-evolution',
        name: 'Growth and evolution',
        description: 'Logical growth charts that connect care conditions to evolved forms. Habitats are separate from evolution branches.',
        Page: EvolutionPage,
      },
      {
        id: 'content-care-assets',
        name: 'Care assets',
        description: 'Snacks, fruit, tonics, and friendly mess markers.',
        Page: CareAssetsPage,
      },
      {
        id: 'content-emotions',
        name: 'Emotion assets',
        description: 'Interchangeable face treatments applied across all pet bodies — eyes, brows, mouth, cheeks, and state accents.',
        Page: EmotionAssetsPage,
      },
      {
        id: 'content-pet-states',
        name: 'Semantic pet states',
        description: 'Full semantic state API: 11 canonical states with face, posture, energy, animation classes, accessible labels, care chains, and distinction pairs.',
        Page: PetStateGalleryDemo,
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        description: 'Interactive catalog of body-state animations (idle, eating, playing) and all twelve emotion animations, with controls and reduced-motion guidance.',
        Page: MotionPage,
      },
    ],
  },
